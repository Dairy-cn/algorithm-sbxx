...
public class GenerateSqlUtil  {
	...
	public void generateSql() throws IOException {
		...
		//sql输出的位置
		File file=new File("C:\\Users\\dairui-004\\Desktop\\sql111.sql");
	...
	public Map<String,Object> readExcel(File file, Workbook book, String sheetName) {
		...
		if (file == null){
			file = new File("C:\\Users\\dairui-004\\Desktop\\111111.xlsx");
		}
		if (book == null){
	...
	public List<Map<String,Object>> readExcel() {
		...
		File file = new File("C:\\Users\\dairui-004\\Desktop\\111111.xlsx");
	...
	public static void main(String[] args) throws IOException {
		new GenerateSqlUtil().generateSql();
	}
}
