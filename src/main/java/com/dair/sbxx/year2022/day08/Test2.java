...
public class Test2 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 100; i++) {
			...
			jobInfo.setBuId(Long.valueOf(new Random().nextInt(10)));
...
//			}
	...
	public static void permutation(JobInfo[] s, Long[] buArr) {
		permutate(s, 0, buArr);
	}
	
	public static void permutate(JobInfo[] arr, int first, Long[] buArr) {
